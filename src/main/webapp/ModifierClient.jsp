...
<h1>Modifier Information Client</h1>
     <hr/>
   <div class="col-md-6">
     ...
     <c:choose>
       <c:when test="${requestScope.res == true }">
          <div class="alert alert-success">
           Modification enregistré avec succées ! <a href="<c:url value="/agent/list-clients" />">Voir Liste</a>
          </div>
       </c:when>
     ...
     <form:form method="post" action="" modelAttribute="client">
       ...
       <div class="col-md-12">
       <br/><br/><br/>
       	<input type="submit" value="Enregistrer Modification" class="btn btn-danger"/>
       </div>
